...
function confirmImport(data){
  ...
  openModal(
    ...
    '<p class="modal-text">O arquivo tem <strong>'+plural(nCasas,'casa','casas')+'</strong>, <strong>'+plural(nInq,'inquilino','inquilinos')+'</strong> e <strong>'+nAnuncios+' anúncio(s) da Vitrine</strong>. '+
