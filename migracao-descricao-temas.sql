-- ============================================================
-- DESCRICAO DOS IMOVEIS + TEMAS POR PROPRIETARIO
-- Execute depois das migracoes anteriores.
-- ============================================================
...
-- O recurso de poco de agua foi removido do produto e dos dados.
...
-- A restauracao atomica passa a conhecer a nova descricao e o tema.
...
begin
  ...
  from jsonb_to_recordset(coalesce(p_payload->'houses','[]'::jsonb)) as x(
    ...
    quartos int,banheiros int,cozinha boolean,sala boolean,garagem boolean,quintal boolean,
    area_servico boolean,energia_ativa boolean,energia_dia_vencimento int
  );
